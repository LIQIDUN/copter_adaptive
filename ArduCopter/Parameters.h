...
public:
    ...
    enum
    {
        ...
        k_param_GeoCtrl_VBS = 296,
        k_param_GeoCtrl_VBE = 297,
        k_param_GeoCtrl_VSS = 298,
        k_param_GeoCtrl_VSE = 299,
        k_param_GeoCtrl_VDS = 300,
        k_param_GeoCtrl_VDE = 301,
        k_param_GeoCtrl_VLS = 302,
        k_param_GeoCtrl_VLE = 303,
        k_param_GeoCtrl_QBS = 304,
        k_param_GeoCtrl_QBE = 305,
        k_param_GeoCtrl_QSS = 306,
        k_param_GeoCtrl_QSE = 307,
        k_param_GeoCtrl_QDS = 308,
    ...
    AP_Int8 GeoCtrl_DBV;
    AP_Float GeoCtrl_VBS; 
    AP_Float GeoCtrl_VBE; 
    AP_Float GeoCtrl_VSS; 
    AP_Float GeoCtrl_VSE; 
    AP_Float GeoCtrl_VDS; 
    AP_Float GeoCtrl_VDE; 
    AP_Float GeoCtrl_VLS; 
    AP_Float GeoCtrl_VLE; 
    AP_Float GeoCtrl_QBS; 
    AP_Float GeoCtrl_QBE; 
    AP_Float GeoCtrl_QSS; 
    AP_Float GeoCtrl_QSE; 
    AP_Float GeoCtrl_QDS; 

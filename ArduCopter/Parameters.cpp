...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Range: 0 - 100
    // @User: Advanced
    GSCALAR(GeoFW_KPX, "GEOFW_KPX", GEOFW_KPX_DEFAULT),
    GSCALAR(GeoFW_KPY, "GEOFW_KPY", GEOFW_KPY_DEFAULT),
    GSCALAR(GeoFW_KPZ, "GEOFW_KPZ", GEOFW_KPZ_DEFAULT),
    GSCALAR(GeoFW_KIX, "GEOFW_KIX", GEOFW_KIX_DEFAULT),
    GSCALAR(GeoFW_KIY, "GEOFW_KIY", GEOFW_KIY_DEFAULT),
    GSCALAR(GeoFW_KIZ, "GEOFW_KIZ", GEOFW_KIZ_DEFAULT),
    GSCALAR(GeoFW_KDX, "GEOFW_KDX", GEOFW_KDX_DEFAULT),
    GSCALAR(GeoFW_KDY, "GEOFW_KDY", GEOFW_KDY_DEFAULT),
    GSCALAR(GeoFW_KDZ, "GEOFW_KDZ", GEOFW_KDZ_DEFAULT),
